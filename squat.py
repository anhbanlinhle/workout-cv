...
down_move_path = "./squat/down_move"
no_move_path = "./squat/no_move"
up_move_path = "./squat/up_move"
...
capture = cv2.VideoCapture("squat.mp4")
...
while True:
    ...
    # Press 's' to save the video
        ...
        cv2.imwrite('./squat/up_move/up_move' + str(up_move_index) +
                    '.png', rgb_representation)
        up_move_index += 1

    elif kk == ord('x'):
        cv2.imwrite('./squat/no_move/no_move' + str(no_move_index) +
                    '.png', rgb_representation)
        no_move_index += 1

    elif kk == ord('c'):
        cv2.imwrite('./squat/down_move/down_move' + str(down_move_index) +
                    '.png', rgb_representation)
        down_move_index += 1
